...
grafico1_5<-ggplot(Experimento, aes(x=Dosis, y=Altura, linetype=Complemento)) + geom_point()+geom_line()

grafico1_6<-ggplot(Experimento, aes(x=Dosis, y=Altura, linetype=Complemento)) + geom_point()+geom_line()+geom_errorbar(aes(ymin=min(Experimento[['Error_Altura']]), ymax=max(Experimento[['Error_Altura']])))
